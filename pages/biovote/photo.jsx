...
const meta = {
  title:
    'โหวตผลงานภาพถ่าย - โครงการวาดภาพและถ่ายภาพทางชีววิทยา | MWIT Open House 2022',
  url: 'biovote/photo',
  description:
...
export default function BioPhotovote({ userData, setData }) {
  ...
  const bookReq = (e, bookId) => {
    e.preventDefault()
    setOnProcess(true)
    fetch(process.env.API_URL + '/api/photovote/', {
      method: 'POST',
      headers: {
          ...
          <div className='flex flex-col justify-center items-center gap-4'>
            ...
            <div className='flex flex-col font-IBMPlexLoop text-gray-700 text-base md:text-lg gap-2 text-center'>
              <span className=''>
                ...
                กันยายน 2565{' '}
                <Link href={'/biovote/draw/'}>
                  <a className='underline text-bmw'>โหวตผลงานภาพวาด</a>
                </Link>
              </span>
                ...
                bookData.map((b, i) => (
                  ...
                  >
                    <div className='grow flex items-center justify-center'>
                      <motion.img
                        src={
                          process.env.CDN_URL + '/img/bio/photo/' + b + '.webp'
                        }
